...
namespace Demo.Logic.Impl
{
    public class WaveIn : IWaveIn
    {
        ...
        /// 获取给定的波形音频输入设备
        /// </summary>
        /// <param name="devNumber">设备号码</param>
        /// <returns>Wave In设备功能</returns>
        ...
        public long GetPosition()
        {
            ...
            MmException.Try(WaveInterop.waveInGetPosition(waveInHandle, out mmTime, Marshal.SizeOf(mmTime)),
                "waveInGetPosition");
